...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      -- Enables the file explorer. Other alternatives to look after are oil and neo-tree
      ...
      -- File explorer keymap (mini.files for now)
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        enable = true,
        disable = { 'csv' }, -- I find native nvim CSV highlighting to be better
