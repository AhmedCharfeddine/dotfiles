...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_documentHighlight, event.buf) then
            ...
            -- TODO: I want to make this instantly highlight references
      ...
      --  - cmd (table): Override the default command to start the server
      --  - filetypes (table): Override the list of filetypes
